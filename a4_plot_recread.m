...
%convert azimuth to color on 361 pt scale
azicolor=round(azi);
azicolorscheme = hsv(361);

%convert distance to color on 181 pt scale
distcolor = round(dists);
distcolorscheme = jet(181);
            ...
            if snr > 0.5
                if (plot_bw==1)
                    ...
                    plot(timeaxis,data*trace_amp+dists(ista),'Color',...
                        azicolorscheme(azicolor(ista)+181,:));
            ...
            if snr > 0.5
                if (plot_bw==1)
                    ...
                    plot(timeaxis,data*trace_amp+azi(ista),'Color',...
                        distcolorscheme(distcolor(ista)+1,:));
